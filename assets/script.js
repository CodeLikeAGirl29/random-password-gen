...
// Declares a variable called passwordLength and assign its value to 11
...
// Creates a function generatePasswords() that return a random password
function generatePasswords() {
  // Declares a variable called password
  let password = "";
...
function changeColorPasswords() {
  ...
  for (let i = 0; i < allPasswords.length; i++) {
    allPasswords[i].style.color = "#10b981";
  }
}
...
// Create an event listener for slider element
